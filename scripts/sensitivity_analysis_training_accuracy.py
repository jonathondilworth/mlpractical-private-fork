...
plt.suptitle("MNIST Training Accuracy using ReLU Variant Activation Functions")

plt.savefig('training_acc_sens_analysis_svg.svg', dpi=None, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format='svg',
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None)

plt.savefig('training_acc_sens_analysis_png.png', dpi=None, facecolor='w', edgecolor='w',
