...
all_stats_005_1 = train_and_process(6102016, 0.5, 100, 1)
all_stats_005_2 = train_and_process(1237878, 0.5, 100, 1)
all_stats_005_3 = train_and_process(2673676, 0.5, 100, 1)
all_stats_005_4 = train_and_process(8978283, 0.5, 100, 1)
all_stats_005_5 = train_and_process(5627351, 0.5, 100, 1)
...
np.save('all_stats_05_avg.npy', all_stats_005_avg)

with open('all_stats_05_avg.txt', 'w') as f: f.write(json.dumps(all_stats_005_avg, default=lambda x: list(x), indent=4))